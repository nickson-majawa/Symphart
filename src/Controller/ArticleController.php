    ...
    class ArticleController extends AbstractController {
        ...
        public function new(Request $request) {
           ...
           ->getForm(); 
            ...
            //test to see if  test has been submitted
           ...
           if($form->isSubmitted() && $form->isValid()) {
                ...
                //after adding values to database redirect to home page
        ...
        public function delete(Request $request, $id) {
            //firts doctrine should find value in database then delete it
            $article = $this->getDoctrine()->getRepository
            (Article::class)->find($id);
